...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    //This method is invoked when the Home button is clicked for iPhone simulator (Simulator -> Harware -> Home)
    ...
    //This method is invoked when the App icon from the Home Screen
    ...
    //or when the app icon is clicked via Home Screen again
    func applicationDidBecomeActive(_ application: UIApplication) {
        // Restart any tasks that were paused (or not yet started) while the application was inactive. If the application was previously in the background, optionally refresh the user interface.
        NSLog("Application: %@", "applicationDidBecomeActive")
    }

    //This method is invoked when the app is closed via Multi-Activity window on iPhone simulator
